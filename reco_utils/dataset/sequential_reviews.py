...
def data_preprocessing(
    ...
    if dataset == 'amazon':
        ...
        reviews_output, meta_output = taobao_main(reviews_file, data_path)
    ...
    instance_output = _create_instance(reviews_output, meta_output, data_path)
    ...
    if dataset == 'kuaishou':
        ...
        preprocessed_output = _data_processing(sampled_instance_file, data_path)
...
def _create_instance(reviews_file, meta_file, data_path):
    logger.info("start create instances...")
    dirs, _ = os.path.split(reviews_file)
    output_file = os.path.join(data_path, "instance_output")
...
def _data_processing(input_file, data_path):
    logger.info("start data processing...")
    # dirs, _ = os.path.split(input_file)
    output_file = os.path.join(data_path, "preprocessed_output")
...
def taobao_main(reviews_file, data_path):
    ...
    reviews_output = os.path.join(data_path, 'taobao_review_recommenders.csv')
    meta_output = os.path.join(data_path, 'taobao_business_recommenders.csv')
